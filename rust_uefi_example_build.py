...
SETTINGS = {
    ...
    'qemu_binary': {
        'x86_64': 'C:/Program Files/qemu/qemu-system-x86_64',
    ...
    'ovmf_dir': Path(r'H:\Documents\Coding\Rust\ovmf\usr\share\edk2.git\ovmf-x64'),
}
        ...
        with open(monitor_input_path, mode='w') as monitor_input,                  \
            ...
            for line in qemu.stdout:
                ...
                if stripped.startswith("SCREENSHOT: "):
                    ...
                    reference_file = WORKSPACE_DIR / 'xos' / 'screenshots' / (reference_name + '.ppm')
