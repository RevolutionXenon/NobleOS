...
pub unsafe fn test_controller() -> bool {PORT_PS2_COMMAND.write(0xAA); wait_for_output(); read_output() == 0x55}
pub unsafe fn test_port_1()     -> bool {PORT_PS2_COMMAND.write(0xAB); wait_for_output(); read_output() == 0x00}
pub unsafe fn test_port_2()     -> bool {PORT_PS2_COMMAND.write(0xA9); wait_for_output(); read_output() == 0x00}
...
pub unsafe fn read_output() -> u8 {PORT_PS2_DATA.read()}
...
pub unsafe fn keyboard_enable_scan()  -> Result<(), &'static str> {
    wait_for_input();
    PORT_PS2_DATA.write(0xF4);
    wait_for_output();
    keyboard_check_response()
}
pub unsafe fn keyboard_disable_scan() -> Result<(), &'static str> {
    wait_for_input();
    PORT_PS2_DATA.write(0xF5);
    wait_for_output();
    keyboard_check_response()
}


// INPUT EVENT HANDLING (TO BE MOVED TO DIFFERENT LIBRARY)
//Input Event
#[derive(Clone, Copy)]
#[derive(Debug)]
#[repr(C)]
